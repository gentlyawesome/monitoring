...
class _Sylvercrud
{
	...
	private function load_config($config)
	{
		...
		// BUTTON FUNCTION
		$this->_delete_button = $this->view_data['delete_button'] = isset($this->_config->delete_button) ? $this->_config->delete_button : false;
		$this->_view_button = $this->view_data['view_button'] = isset($this->_config->view_button) ? $this->_config->view_button : false;
		$this->_edit_button = $this->view_data['edit_button'] = isset($this->_config->edit_button) ? $this->_config->edit_button : false;
