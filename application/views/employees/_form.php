<?php
  $empid = isset($employee)?$employee->empid:'';
  $last_name = isset($employee)?$employee->last_name:'';
  $first_name = isset($employee)?$employee->first_name:'';
  $middle_name = isset($employee)?$employee->middle_name:'';
  $gender = isset($employee)?$employee->gender:'';
  $dob = isset($employee)?$employee->dob:'';
  $email = isset($employee)?$employee->email:'';
?>
...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="empid" name="data[empid]" type="text" placeholder="Login" class="form-control input-md" maxlength="12" value="<?=isset($empid)?$empid:''?>" <?=isset($employee)?'disabled':'required'?>>
